...
function App() {
  ...
  return (
   ...
   <Nav/><br/>
    <br/><br/><br/><br/>
    <div className="text">
      그렇다면 이렇게 <span style={{color:'red'}}></span>학원 2개를 운영하실 정도로 부지런한 영어선생님은 어떤 분이실까요?? <br/>
      아이들과 부모님들께 항상 '송 선생님~'이라고 불리우시는 선생님께서는 교사 경력이 20년이나 되는 <br/>
      베테랑 선생님이십니다! <br/><br/><br/>
      저도 선생님과 10년이나 함께 했는데요,,ㅎㅎ<br/>
      선생님께서는 영어 교육 뿐만 아니라 <span style={{color:'red'}}>초중고 전반에 거쳐 어떻게 공부해야 하는지,<br/>
      어떤 책을 써서 공부하는 게 좋은지, 또 어디 학교에 가서 공부를 하는 게 효율적일지에 대한<br/>
      전반적인 공부 관리</span>에 매우 능통하신 분이십니다. <br/><br/><br/>
